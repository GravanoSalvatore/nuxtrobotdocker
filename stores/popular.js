...
//       this.tags = []; // Очищаем текущий список тегов
//       this.progress = 0;
...
//             // Прерываем цикл, если данные закончились
//             break;
//           }
...
//           console.log(`Загружено тегов: ${this.tags.length}`);
//         }
    
//         console.log("Все теги успешно загружены:", this.tags.length);
//         this.progress = 100; // Устанавливаем прогресс на 100%
//       } catch (error) {
//         console.error("Ошибка при поиске тегов:", error);
//         this.tags = [];
...
//     //     let page = 1;
//     //     const pageSize = 100; // Размер страницы
//     //     const maxTags = 10000; // Максимальное количество тегов
    
//     //     while (this.tags.length < maxTags) {
//     //       const response = await axios.get(
//     //         `https://4v-news-api.azurewebsites.net/Tags/Search`,
//     //         {
//     //           params: {
...
//     //         this.tags = this.tags.slice(0, maxTags);
//     //         break;
//     //       }
